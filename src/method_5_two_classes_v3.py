...
arg_model_name = "method_5_two_class" # model name to be saves
...
weights_file_path = "../weight_files/LAST_20181206-100505:24_9_cvc_356_612_weighted_folders_weights-improvement-09-0.9870.hdf5"
...
class MyDenseNet(nn.Module):
    def __init__(self, pretrained=False):
        ...
        if pretrained:
            self.best_weight_file_path = "../weight_files/20180904-133210:23_2_weights-improvement-04-0.9556.hdf5"
...
def prepare_submission_file(image_names, predicted_labels, max_probability, time_per_image, submit_dir, data_classes):
    ...
    submission_dataframe.to_csv(os.path.join(submit_dir, "method_5_test_output"), index=False)
