...
arg_model_name = "method_3_two_class_after_retrainig" # model name to be saves
...
weights_file_path = "../weight_files/LAST_20181205-071359:20_8_cvc_356_612_weighted_folders_weights-improvement-09-0.9808.hdf5" #20180824-172507:20_1_modifiedData_weights-improvement-00-0.9537.hdf5"
...
def test_model(test_model,test_dataloader):
    ...
    cm = confusion_matrix(y_true, y_predicted, target_number_labels)  # confusion matrix
...
num_ftrs = model_ft.fc.in_features
model_ft.fc = nn.Linear(num_ftrs, 2) # changing 16 to 2 for polyp - non-polyp detections
...
if arg_mode == "test":
    ...
    prepare_submission_file(test_image_names,
                            ...
                            data_classes= test_datasets.classes,
